          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="text-gray-400 border-b border-white/10 text-sm uppercase tracking-wider">
                ...
                <th className="pb-4 pt-2 font-semibold text-center">ViralMind Score</th>
                  ...
                  <tr key={creator.username} className={`border-b border-white/5 hover:bg-white/5 transition-all group ${isTop3 ? 'bg-white/[0.02]' : ''}`}>
                    ...
                    <td className="py-5 text-center">
                      <div className="inline-flex items-center justify-center w-14 h-14 rounded-full border-4 border-primary/20 relative">
                        <span className="font-bold text-primary text-lg">{creator.viralmind_score}</span>
                        <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 36 36">
                          <path
                            className="text-primary"
                            strokeDasharray={`${creator.viralmind_score}, 100`}
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const htmlContent = `
        <html>
          <head>
            <title>ViralMind AI Report - ${username}</title>
            <style>
          ...
          <body>
            <div class="header">
              <div class="logo">ViralMind AI Engine</div>
            ...
            <p style="text-align: center; margin-top: 50px; font-size: 12px; color: #888;">
              This document was automatically generated by the ViralMind AI Intelligence Platform.
            </p>
            ...
            <div key={i} className={`glass-card border-t-4 ${i === 0 ? 'border-primary' : 'border-secondary'}`}>
              ...
              <div className="space-y-4">
                <div className="flex justify-between pb-2 border-b border-white/10">
                  <span className="text-gray-400">ViralMind Score</span>
                  <span className="font-bold text-success">{inf.viralmind_score}/100</span>
                </div>
                <div className="flex justify-between pb-2 border-b border-white/10">
                  <span className="text-gray-400">Followers</span>
